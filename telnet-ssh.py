...
def start_connection():
    try:
        ...
        device_type = 'cisco_ios' if protocol == 'SSH' else 'cisco_telnet'
...
tk.Label(root, text="Connection Protocol:").pack(pady=5)
tk.Radiobutton(root, text="SSH", variable=protocol_var, value='SSH').pack(pady=5)
tk.Radiobutton(root, text="Telnet", variable=protocol_var, value='Telnet').pack(pady=5)
